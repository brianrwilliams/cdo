...
\noindent Here, $\cX(X^{coor})$ is understood as the inverse limit of the Lie algebras $\cX(X^{coor}_k)$. \si 
The superscript $hol$ means the inverse limit of the sub-Lie algebras of holomorphic vector fields.
