...
& f & \mapsto & \frac{1}{3} \tr\left( (Df^{-1}\d_{dR} Df)^3\right) .
\end{array}
\een
...
Jacobian we compute
\bestar
\frac{1}{3} \left(Df^{-1} \d_{dR} Df\right)^3 & = & \frac{1}{3} \left(Df_1^{-1} f_1^*(Df_2^{-1} \d_{dR}
Df_2) Df_1\right)^3 + \frac{1}{3} \left(Df_1^{-1} \d_{dR} Df_1\right)^3 +
\{{\rm cross \; terms}\} .
\eestar
