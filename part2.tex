...
\een
that produces an $L_\infty$ map on $\fgn^S$ from a function on the formal $n$-disk,
...
\ben
\sum_{\Gamma \in \text{\rm Wheels}} \frac{1}{|\Aut(\Gamma)|} W_\Gamma(P_{0 < \infty}, \Tilde{I}^{\rm W}) .
\een
